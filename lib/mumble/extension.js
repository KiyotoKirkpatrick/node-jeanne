...
const tts = require('stumble/lib/ext/tts')
...
const resume = {
	handle: "play",
	exec: function (data) {
		if (this.space.get('player').playing) {
...
const info = {
	...
	commands: [{
		...
		exec: function (data) {
			...
			const link = utils.link_with_title('https://github.com/KiyotoKirkpatrick/node-jeanne#commands', "find information online")
...
module.exports = {
	...
	extensions: [info, youtube, notepad, voiceCommand, audio, parser, tts],
